...
``` typescript
import pkg from 'https://unpkg.com/cachely@^6.4.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/cachely@^6.4.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/cachely@^6.4.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/cachely@6.4.0'
</script>
```
