...
``` typescript
import pkg from 'https://unpkg.com/cachely@^5.11.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/cachely/^5.11.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/cachely@^5.11.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/cachely@5.11.0'
</script>
```
